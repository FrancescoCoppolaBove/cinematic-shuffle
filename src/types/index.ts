...
export interface MovieFilters {
  ...
  withAwards?: boolean;           // Oscar nominations/wins
  language?: string;              // ISO 639-1 (e.g. 'en', 'it', 'ja', 'ko', 'fr')
  originCountry?: string;         // ISO 3166-1 (e.g. 'US', 'IT', 'JP', 'KR', 'FR')
}
...
export const DECADES = [
  { label: '1930s', value: '1930s', start: 1930, end: 1939 },
  { label: '1940s', value: '1940s', start: 1940, end: 1949 },
  { label: '1950s', value: '1950s', start: 1950, end: 1959 },
  { label: '1960s', value: '1960s', start: 1960, end: 1969 },
  { label: '1970s', value: '1970s', start: 1970, end: 1979 },
  { label: '1980s', value: '1980s', start: 1980, end: 1989 },
  { label: '1990s', value: '1990s', start: 1990, end: 1999 },
