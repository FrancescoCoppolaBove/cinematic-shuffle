...
export function InnerMovieDetail({
  ...
  return (
    <Fragment>
    <div className="fixed left-0 right-0 z-[95]" style={{ top: 0, bottom: 0, isolation: 'isolate', pointerEvents: innerMovie ? 'none' : undefined }}>
      <MovieDetailScreen
        movie={movie}
        isWatched={isWatched}
...
export function PersonInner(props: {
  ...
  const [innerMovie, setInnerMovie] = useState<{ id: number; mediaType: 'movie' | 'tv' } | null>(null);
  return (
    <div className="fixed left-0 right-0 z-[98]" style={{ top: 0, bottom: 0, isolation: 'isolate' }}>
      <PersonDetailScreen
